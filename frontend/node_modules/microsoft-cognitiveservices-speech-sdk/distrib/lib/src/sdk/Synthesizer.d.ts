...
export declare class SynthesisRequest {
    ...
    err: (e: string) => void;
    dataStream: IAudioDestination | undefined;
...
export declare class StreamingSynthesisRequest {
    requestId: string;
    speechSynthesisRequest: SpeechSynthesisRequest;
    cb: (e: SpeechSynthesisResult) => void;
    err: (e: string) => void;
    dataStream: IAudioDestination | undefined;
    constructor(requestId: string, speechSynthesisRequest: SpeechSynthesisRequest, cb?: (e: SpeechSynthesisResult) => void, err?: (e: string) => void, dataStream?: IAudioDestination);
}
