...
export declare class SpeechSynthesizer extends Synthesizer {
     ...
     * @param stream - AudioOutputStream to receive the synthesized audio.
     */
    speakAsync(request: SpeechSynthesisRequest, cb?: (e: SpeechSynthesisResult) => void, err?: (e: string) => void, stream?: AudioOutputStream | PushAudioOutputStreamCallback | PathLike): void;
    /**
    ...
    private resolveAudioDestination;
